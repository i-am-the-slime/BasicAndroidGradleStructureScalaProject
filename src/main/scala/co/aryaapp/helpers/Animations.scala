...
object Animations {
  ...
  def moveDownAndOut(v: View, duration:Int, delay:Int):MarkAnimation = {
    val a = new TranslateAnimation(0f, 0f, 0f, v.getHeight+20)  with MarkAnimation
    applyBasicAttributes(a, duration, delay)
  }

  def moveUpAndIn(v: => View, duration:Int, delay:Int):MarkAnimation = {
    lazy val view = v
    view.setVisibility(View.VISIBLE)
    val a = new TranslateAnimation(0f, 0f, view.getHeight+20, 0) with MarkAnimation
    applyBasicAttributes(a, duration, delay)
  }

  def appearByRotation(duration:Int, delay:Int=0):MarkAnimation = {
  ...
  def wiggle(delay:Int=0):MarkAnimation = {
  ...
  def cartoonDashAway(delay:Int=0, clbk:MarkAnimation => Any):MarkAnimation = {
